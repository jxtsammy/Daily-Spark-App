...
export default function RecentQuotesScreen({ navigation }) {
  // State for quotes
  ...
  const handleDeleteQuote = (quoteId) => {
    Alert.alert("Delete Quote", "Are you sure you want to delete this quote from your recent history?", [
      {
        text: "Cancel",
        style: "cancel",
      },
  ...
  const EmptyState = () => (
    <View style={styles.emptyState}>
      ...
      <Text style={styles.emptyStateTitle}>No recent quotes</Text>
      <Text style={styles.emptyStateText}>
        Quotes you've recently viewed will appear here. Explore topics to discover new quotes.
      </Text>
    </View>
  )
  ...
  return (
    <ImageBackground source={require("../../../assets/3.jpg")} style={styles.backgroundImage}>
      <LinearGradient colors={["rgba(0, 0, 0, 1)", "rgba(0, 0, 0, 0.2)"]} style={styles.container}>
          ...
          <SafeAreaView style={styles.safeArea}>
            <View style={styles.header}>
              <View style={styles.headerLeft}>
                ...
                <Text style={styles.headerTitle}>Recent Quotes</Text>
              </View>
            ...
            <LinearGradient colors={["rgba(0, 0, 0, 0.5)", "rgba(0, 0, 0, 0.3)"]} style={styles.modalOverlay}>
              <SafeAreaView style={styles.modalContainer}>
                ...
                <View style={styles.modalHeader}>
                  ...
                  <Text style={styles.modalHeaderTitle}>Recent Quotes</Text>
                  <TouchableOpacity
