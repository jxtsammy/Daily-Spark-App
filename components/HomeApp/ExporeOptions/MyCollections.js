...
export default function ExploreScreen({ navigation }) {
  ...
  return (
    ...
    >
      <LinearGradient 
        colors={['rgba(0, 0, 0, 1)', 'rgba(0, 0, 0, 0.25)']} 
      ...
      >
          ...
          {filteredQuotes.length > 0 ? (
            <Animated.FlatList
              ...
              onScroll={Animated.event(
                [{ nativeEvent: { contentOffset: { y: quotesScrollY } } }],
                { useNativeDriver: true }
              )}
        ...
        >
          <ImageBackground
            source={{ uri: 'https://images.unsplash.com/photo-1534796636912-3b95b3ab5986?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&w=1000&q=80' }}
            style={styles.backgroundImage}
          >
            <LinearGradient 
              colors={['rgba(2, 2, 2, 0.1)', 'rgba(2, 2, 2, 0.9)']} 
              style={styles.container}
            >
              <StatusBar barStyle="light-content" backgroundColor="transparent" translucent />
